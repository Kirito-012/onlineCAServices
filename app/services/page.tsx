  ...
  return (
    ...
    <main className="bg-gray-50 text-gray-900">
      ...
      <section className="relative bg-[url('/s4.png')] bg-cover bg-center bg-no-repeat max-w-7xl mx-auto px-6 py-16 md:py-20 text-center text-white">
        ...
        >
          <h1 className="text-3xl md:text-5xl pt-16 font-extrabold text-white">
            💼 Our Services – Online CA Services
          </h1>
          <p className="mt-4 max-w-2xl mx-auto text-gray-100">
            📍 Trusted platform connecting users with qualified professionals
            for all their Income Tax, GST, Accounting, and Business Compliance
            needs across India.
          </p>
      ...
      <section id="all-services" className="max-w-7xl mx-auto px-6 pb-16">
        <motion.div
        ...
        >
          <h2 className="text-sm uppercase pt-8 tracking-widest text-gray-500">
            Our Expertise
          </h2>
      ...
      <section className="bg-white border-t py-16 text-center px-6">
        ...
        >
          Connect with a verified Chartered Accountant and manage your business
          or taxes professionally — all online.
        </motion.p>
